# E-Bike Sharing Startup — Data Analytics Project
**Analytics Project - Using Google BigQuery**

**Project Overview**

This project analyzes the operational and business performance of an e-bike sharing startup using **SQL in Google BigQuery**.
The goal is to uncover **usage patterns, demand peaks, station imbalances, user behavior**, and growth trends to support data-driven decision-making.
